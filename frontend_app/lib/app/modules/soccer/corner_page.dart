...
class CornerPage extends StatefulWidget {
  final List usuarioLogado;
  const CornerPage({super.key, required this.usuarioLogado});

  @override
  State<CornerPage> createState() => _CornerPageState();
}

class _CornerPageState extends State<CornerPage> {
              ...
              children: [
                ...
                Builder(
                  builder: (context) {
                    if (isLoading) {
                    ...
                    } else if (bolaParadaController.batedoresEscanteio.isEmpty) {
                      return Expanded(
                        child: Center(
                          child: Column(
                      ...
                      return Expanded(
                        child: ListView.separated(
                          ...
                          itemCount: bolaParadaController.batedoresEscanteio.length,
                          itemBuilder: (_, index) {
                            var result =
                                bolaParadaController.batedoresEscanteio[index];
                            return batedoresEscanteioTime(result);
                          },
                        ),
                      );
                    }
  ...
  Widget batedoresEscanteioTime(dynamic result) {
    return Row(
