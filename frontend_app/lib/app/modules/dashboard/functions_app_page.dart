  ...
  Widget build(BuildContext context) {
    return Scaffold(
                        ...
                        children: [
                          ...
                          Row(
                            children: const [
                              Image(
                                image:
                                    AssetImage("images/icons-tournament.png"),
                                height: 35,
                                width: 35,
                              ),
                              Text(
                          ...
                          Row(
                            children: const [
                              Image(
                                image:
                                    AssetImage("images/icons-score-board.png"),
                                height: 35,
                                width: 35,
                              ),
                              Text(
                          ...
                          Row(
                            children: const [
                              Image(
                                image: AssetImage(
                                    "images/icons-board-strategy.png"),
                                height: 35,
                                width: 35,
                              ),
                              Text(
        ...
        bottomNavigationBar: Container(
          ...
          padding:
              const EdgeInsets.only(left: 90, right: 90, bottom: 5, top: 11),
